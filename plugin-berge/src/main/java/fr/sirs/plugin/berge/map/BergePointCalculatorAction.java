 ...
 * @author guilhem
 */
public class BergePointCalculatorAction extends FXMapAction {
    ...
    public BergePointCalculatorAction(FXMap map) {
        ...
        map.getHandlerProperty().addListener(new ChangeListener<FXCanvasHandler>() {
            ...
            public void changed(ObservableValue<? extends FXCanvasHandler> observable, FXCanvasHandler oldValue, FXCanvasHandler newValue) {
                selectedProperty().set(newValue instanceof BergePointCalculatorHandler);
            }
        });
    }
    ...
    public void accept(ActionEvent event) {
        if (map != null && !(map.getHandler() instanceof BergePointCalculatorHandler)) {
            map.setHandler(new BergePointCalculatorHandler());
        }
    }
