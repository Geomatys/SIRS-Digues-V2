 ...
 */
class SysEvtOuvrageParticulierEchelleLimnimetriqueImporter extends GenericReseauImporter<EchelleLimnimetrique> {

    SysEvtOuvrageParticulierEchelleLimnimetriqueImporter(final Database accessDatabase,
...
//        ID_AUTO
    ...
    public String getTableName() {
        return SYS_EVT_OUVRAGE_PARTICULIER.toString();
    }
    ...
    public public  importRow(Row row) throws IOException, AccessDbImporterException {
        ...
        try {
            ...
            try {
                ...
                Logger.getLogger(SysEvtOuvrageParticulierEchelleLimnimetriqueImporter.class.getName()).log(Level.WARNING, null, ex);
            }
