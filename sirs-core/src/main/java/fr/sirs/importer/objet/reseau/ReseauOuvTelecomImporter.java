...
class ReseauOuvTelecomImporter extends GenericImporter {
    ...
    private Map<Integer, List<ReseauReseau>> reseauOuvrages = null;
     ...
     * @throws IOException 
     */
    public Map<Integer, List<ReseauReseau>> getReseauOuvrageTelecom() throws IOException, AccessDbImporterException {
    ...
    protected void compute() throws IOException, AccessDbImporterException {
        ...
        while (it.hasNext()) {
            ...
            List<ReseauReseau> listByReseauId = reseauOuvrages.get(row.getInt(ReseauOuvrageTelecomColumns.ID_ELEMENT_RESEAU.toString()));
