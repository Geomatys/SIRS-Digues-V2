...
//        ID_AUTO
    ...
    public String getTableName() {
        return SYS_EVT_OUVERTURE_BATARDABLE.toString();
    }
    ...
    public public  importRow(Row row) throws IOException, AccessDbImporterException {
        ...
        final OuvertureBatardable ouverture = createAnonymValidElement(OuvertureBatardable.class);
        
        ouverture.setLinearId(troncon.getId());
        ...
        try {
            ...
            try {
                ...
                Logger.getLogger(SysEvtOuvertureBatardableImporter.class.getName()).log(Level.WARNING, null, ex);
            }
        ...
        ouverture.setDesignation(String.valueOf(row.getInt(Columns.ID_ELEMENT_RESEAU.toString())));
        ouverture.setGeometry(buildGeometry(troncon.getGeometry(), ouverture, tronconGestionDigueImporter.getBorneDigueRepository()));
