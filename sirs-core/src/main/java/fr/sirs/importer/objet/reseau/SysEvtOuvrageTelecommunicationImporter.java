...
//        ID_AUTO
    ...
    public public  importRow(Row row) throws IOException, AccessDbImporterException {
        ...
        try {
            context.setGeoPositions(row, ouvrage);
        } catch (TransformException ex) {
            context.reportError(new ErrorReport(ex, row, getTableName(), null, ouvrage, null, "Cannnot set geographic position.", CorruptionLevel.FIELD));
        }
