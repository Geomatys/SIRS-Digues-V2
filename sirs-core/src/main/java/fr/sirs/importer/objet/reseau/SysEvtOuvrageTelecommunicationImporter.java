...
//        ID_AUTO
    ...
    public String getTableName() {
        return SYS_EVT_OUVRAGE_TELECOMMUNICATION.toString();
    }

    @Override
    public OuvrageTelecomEnergie importRow(Row row) throws IOException, AccessDbImporterException {
        ...
        final Map<Integer, RefOuvrageTelecomEnergie> typesOuvrage = typeOuvrageTelecomImporter.getTypeReferences();

        final OuvrageTelecomEnergie ouvrage = createAnonymValidElement(OuvrageTelecomEnergie.class);
        ...
        if (row.getDate(Columns.DATE_DEBUT_VAL.toString()) != null) {
            ouvrage.setDate_debut(DbImporter.parseLocalDate(row.getDate(Columns.DATE_DEBUT_VAL.toString()), dateTimeFormatter));
        }

        if (row.getDate(Columns.DATE_FIN_VAL.toString()) != null) {
            ouvrage.setDate_fin(DbImporter.parseLocalDate(row.getDate(Columns.DATE_FIN_VAL.toString()), dateTimeFormatter));
        }
        ...
        try {
            ...
            try {
                ...
                Logger.getLogger(SysEvtOuvrageTelecommunicationImporter.class.getName()).log(Level.WARNING, null, ex);
            }
