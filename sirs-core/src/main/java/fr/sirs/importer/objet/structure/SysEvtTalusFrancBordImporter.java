 ...
 */
class SysEvtTalusFrancBordImporter extends GenericStructureImporter<FrontFrancBord> {
    ...
    public String getTableName() {
        return DbImporter.TableName.SYS_EVT_TALUS_FRANC_BORD.toString();
    }
    ...
    protected void compute() throws IOException, AccessDbImporterException {
        ...
        while (it.hasNext()) {
            ...
            List<FrontFrancBord> listByTronconId = structuresByTronconId.get(row.getInt(Columns.ID_TRONCON_GESTION.toString()));
    ...
    public FrontFrancBord importRow(Row row) throws IOException, AccessDbImporterException {
        ...
        if (row.getDate(Columns.DATE_DEBUT_VAL.toString()) != null) {
            talus.setDate_debut(DbImporter.parse(row.getDate(Columns.DATE_DEBUT_VAL.toString()), dateTimeFormatter));
        }

        if (row.getDate(Columns.DATE_FIN_VAL.toString()) != null) {
            talus.setDate_fin(DbImporter.parse(row.getDate(Columns.DATE_FIN_VAL.toString()), dateTimeFormatter));
        }
