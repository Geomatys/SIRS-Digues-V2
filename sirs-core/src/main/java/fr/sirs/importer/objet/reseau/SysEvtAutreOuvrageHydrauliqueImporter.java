 ...
 */
class SysEvtAutreOuvrageHydrauliqueImporter extends GenericReseauImporter<OuvrageHydrauliqueAssocie> {
    ...
    public OuvrageHydrauliqueAssocie importRow(Row row) throws IOException, AccessDbImporterException {
        ...
        try {
            ...
            try {
                ...
                Logger.getLogger(SysEvtAutreOuvrageHydrauliqueImporter.class.getName()).log(Level.WARNING, null, ex);
            }
