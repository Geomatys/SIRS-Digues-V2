 ...
 */
class SysEvtPrestationImporter extends GenericPrestationImporter<Prestation> {
...
//            }
            ...
            if(row.getInt(Columns.ID_SYSTEME_REP.toString())!=null){
             ...
             if (row.getDouble(Columns.ID_BORNEREF_DEBUT.toString()) != null) {
                ...
                if(b!=null) prestation.setBorneDebutId(b.getId());
            }
            ...
            if (row.getDouble(Columns.ID_BORNEREF_FIN.toString()) != null) {
                ...
                if (b!=null) prestation.setBorneFinId(b.getId());
            }
