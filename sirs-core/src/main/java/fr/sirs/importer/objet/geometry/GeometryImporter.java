...
//        final Map<Integer, TalusRisberme> talusRisbermes = talusRisbermeImporter.getStructures();
        ...
        while (it.hasNext()) {
            ...
            final int structureId = row.getInt(ElementGeometryColumns.ID_ELEMENT_STRUCTURE.toString());
            final Class typeStructure = this.typeElementGeometryImporter.getTypeElementStructure().get(row.getInt(ElementGeometryColumns.ID_TYPE_ELEMENT_STRUCTURE.toString()));
