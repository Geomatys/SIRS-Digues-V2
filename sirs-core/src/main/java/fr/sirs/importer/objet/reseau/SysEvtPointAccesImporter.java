...
//        ID_AUTO
    ...
    public OuvrageFranchissement importRow(Row row) throws IOException, AccessDbImporterException {
        ...
        if (row.getDate(Columns.DATE_FIN_VAL.toString()) != null) {
            pointAcces.setDate_fin(LocalDateTime.parse(row.getDate(Columns.DATE_FIN_VAL.toString()).toString(), dateTimeFormatter));
        }
        ...
        pointAcces.setPseudoId(row.getInt(Columns.ID_ELEMENT_RESEAU.toString()));
