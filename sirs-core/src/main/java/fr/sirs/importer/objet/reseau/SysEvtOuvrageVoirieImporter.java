 ...
 */
class SysEvtOuvrageVoirieImporter extends GenericObjetImporter<OuvrageVoirie> {
...
//        ID_AUTO
    ...
    public String getTableName() {
        return DbImporter.TableName.SYS_EVT_OUVRAGE_VOIRIE.toString();
    }
    ...
    protected void compute() throws IOException, AccessDbImporterException {
        ...
        final Map<Integer, RefOuvrageVoirie> typesOuvrageVoirie = typeOuvrageVoirieImporter.getTypes();
        final Map<Integer, RefPosition> typesPosition = typePositionImporter.getTypes();
        
        final Iterator<Row> it = this.accessDatabase.getTable(getTableName()).iterator();
        while (it.hasNext()) {
            final Row row = it.next();
            final OuvrageVoirie ouvrage = new OuvrageVoirie();
...
//            
            ...
            List<OuvrageVoirie> listByTronconId = structuresByTronconId.get(row.getInt(Columns.ID_TRONCON_GESTION.toString()));
