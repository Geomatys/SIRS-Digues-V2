...
//        ID_AUTO
    ...
    public TalusRisberme importRow(Row row) throws IOException, AccessDbImporterException {
        ...
        if (row.getDate(Columns.DATE_DEBUT_VAL.toString()) != null) {
            talusRisberme.setDate_debut(DbImporter.parse(row.getDate(Columns.DATE_DEBUT_VAL.toString()), dateTimeFormatter));
        }

        if (row.getDate(Columns.DATE_FIN_VAL.toString()) != null) {
            talusRisberme.setDate_fin(DbImporter.parse(row.getDate(Columns.DATE_FIN_VAL.toString()), dateTimeFormatter));
        }
