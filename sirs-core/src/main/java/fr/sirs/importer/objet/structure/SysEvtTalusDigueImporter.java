...
//        ID_AUTO
    ...
    public String getTableName() {
        return SYS_EVT_TALUS_DIGUE.toString();
    }
    ...
    public public  importRow(Row row) throws IOException, AccessDbImporterException {
        ...
        final TalusDigue talus = createAnonymValidElement(TalusDigue.class);
        
        talus.setLinearId(troncon.getId());
        ...
        if (row.getDate(Columns.DATE_DEBUT_VAL.toString()) != null) {
            talus.setDate_debut(DbImporter.parseLocalDate(row.getDate(Columns.DATE_DEBUT_VAL.toString()), dateTimeFormatter));
        }

        if (row.getDate(Columns.DATE_FIN_VAL.toString()) != null) {
            talus.setDate_fin(DbImporter.parseLocalDate(row.getDate(Columns.DATE_FIN_VAL.toString()), dateTimeFormatter));
        }
        ...
        try {
            ...
            try {
                ...
                Logger.getLogger(SysEvtTalusDigueImporter.class.getName()).log(Level.WARNING, null, ex);
            }
