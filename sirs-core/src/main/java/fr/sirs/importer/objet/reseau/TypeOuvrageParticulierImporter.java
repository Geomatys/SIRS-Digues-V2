...
class TypeOuvrageParticulierImporter extends GenericTypeReferenceImporter<RefOuvrageParticulier> {
    ...
    public String getTableName() {
        return DbImporter.TableName.TYPE_OUVRAGE_PARTICULIER.toString();
    }
    ...
    protected void compute() throws IOException {
        ...
        while (it.hasNext()) {
            ...
            typeOuvrage.setPseudoId(row.getInt(String.valueOf(Columns.ID_TYPE_OUVRAGE_PARTICULIER.toString())));
