...
/**
 * IMPORTANT : WE SET GEOGRPHIC START AND POINT AS LINEAR REFERENCING, BUT WE
 * CANNOT SET GEOMETRY HERE, BECAUSE WE DO NOT KNOW TRONCON ID YET.
 *
 * @author Alexis Manin (Geomatys)
 */
public abstract class AbstractPositionableImporter<T extends Positionable> extends DocumentImporter<T> {

    protected GenericImporter<BorneDigue> borneImporter;
    protected GenericImporter<SystemeReperage> srImporter;
