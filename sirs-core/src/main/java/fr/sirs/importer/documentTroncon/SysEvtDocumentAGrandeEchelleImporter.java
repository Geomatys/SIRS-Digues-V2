...
import static fr.sirs.importer.DbImporter.TableName.SYS_EVT_DOCUMENT_A_GRANDE_ECHELLE;
 ...
 */
class SysEvtDocumentAGrandeEchelleImporter extends GenericPositionDocumentImporter<PositionDocument> {
    ...
    PositionDocument importRow(Row row) throws IOException, AccessDbImporterException {
        ...
        try {
            ...
            try {
                ...
                Logger.getLogger(SysEvtDocumentAGrandeEchelleImporter.class.getName()).log(Level.WARNING, null, ex);
            }
        ...
        if (row.getInt(Columns.ID_DOC.toString()) != null) {
            if (documentsGrandeEchelle.get(row.getInt(Columns.ID_DOC.toString())) != null) {
                position.setSirsdocument(documentsGrandeEchelle.get(row.getInt(Columns.ID_DOC.toString())).getId());
            }
        }
