 ...
 * @author Johann Sorel
 */
public class CreateHerbaceTool extends AbstractEditionTool{
        ...
        public Spi() {
            super("CreatePeuplement",
                new ResourceInternationalString("fr/sirs/plugin/vegetation/bundle", 
                        "fr.sirs.plugin.vegetation.map.CreateArbreTool.title",CreateHerbaceTool.class.getClassLoader()),
                new ResourceInternationalString("fr/sirs/plugin/vegetation/bundle", 
                        "fr.sirs.plugin.vegetation.map.CreateArbreTool.abstract",CreateHerbaceTool.class.getClassLoader()),
                new Image("fr/sirs/plugin/vegetation/herbacé.png"));
        }
