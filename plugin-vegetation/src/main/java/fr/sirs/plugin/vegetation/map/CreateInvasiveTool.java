 ...
 * @author Johann Sorel
 */
public class CreateInvasiveTool extends AbstractEditionTool{
        ...
        public Spi() {
            super("CreatePeuplement",
                new ResourceInternationalString("fr/sirs/plugin/vegetation/bundle", 
                        "fr.sirs.plugin.vegetation.map.CreateArbreTool.title",CreateInvasiveTool.class.getClassLoader()),
                new ResourceInternationalString("fr/sirs/plugin/vegetation/bundle", 
                        "fr.sirs.plugin.vegetation.map.CreateArbreTool.abstract",CreateInvasiveTool.class.getClassLoader()),
