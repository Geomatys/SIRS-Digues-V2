...
public class CreatePeuplementTool extends AbstractEditionTool{
        ...
        public Spi() {
            super("CreatePeuplement",
                new ResourceInternationalString("fr/sirs/plugin/vegetation/bundle", 
                        "fr.sirs.plugin.vegetation.map.CreateArbreTool.title",CreatePeuplementTool.class.getClassLoader()),
                new ResourceInternationalString("fr/sirs/plugin/vegetation/bundle", 
                        "fr.sirs.plugin.vegetation.map.CreateArbreTool.abstract",CreatePeuplementTool.class.getClassLoader()),
    ...
    public CreatePeuplementTool(FXMap map) {
        ...
        lbl1.getStyleClass().add("property");
        lbl2.getStyleClass().add("property");
        lblParcelle.getStyleClass().add("value");
        lblPoint.getStyleClass().add("value");
