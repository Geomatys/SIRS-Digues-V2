...
//            crete.setConventionIds(null);
            crete.setCote(row.getString("COTE_AXE"));
//            crete.setDateMaj(LocalDateTime.MIN);
//            crete.setDate_debut(LocalDateTime.MIN);
//            crete.setDate_fin(LocalDateTime.MIN);EPAISSEUR
                if (row.getDouble("EPAISSEUR") != null) {
                    crete.setEpaisseur(row.getDouble("EPAISSEUR").floatValue());
                }
...
//            }
            if (row.getDate("DATE_DEBUT_VAL") != null) {
                crete.setDate_debut(LocalDateTime.parse(row.getDate("DATE_DEBUT_VAL").toString(), dateTimeFormatter));
            }
            if (row.getDate("DATE_FIN_VAL") != null) {
                crete.setDate_fin(LocalDateTime.parse(row.getDate("DATE_FIN_VAL").toString(), dateTimeFormatter));
            }
