...
public class DatePicker extends HBox {
    ...
    public DatePicker(Locale locale) {
            ...
            public void changed(ObservableValue<? extends String> observableValue, String s, String s1) {
                ...
                if (s1.equals("")) {
                    ...
                    timer.schedule(new TimerTask() {
                        @Override
                        public void run() {
                            Platform.runLater(() -> tryParse(false));
                        }
                    }, 1000);
                }
            }
        ...
        localeProperty().addListener(observable -> {
            updateTextField();
        });
        ...
        button.setOnAction(actionEvent -> showPopup());
        ...
        getStylesheets().addListener((Observable observable) -> {
