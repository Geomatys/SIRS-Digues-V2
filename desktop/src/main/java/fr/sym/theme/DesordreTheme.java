...
public class DesordreTheme extends AbstractTronconTheme {
    ...
    private static final ThemeGroup GROUP1 = new ThemeGroup("Voie d'accès", Desordre.class, (TronconDigue t) -> t.stuctures.filtered((Structure t1) -> t1 instanceof Desordre));
