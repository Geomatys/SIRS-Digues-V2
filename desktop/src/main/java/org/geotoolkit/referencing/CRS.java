...
public final class CRS extends Static {
     ...
     */
    private static final Map<String,String> HACK = new HashMap<>();
    static {
        //old lambert
        HACK.put("NTF_Lambert_Zone_I",      "EPSG:27561");
        HACK.put("NTF_Lambert_Zone_II",     "EPSG:27562");
        HACK.put("NTF_Lambert_Zone_III",    "EPSG:27563");
        HACK.put("NTF_Lambert_Zone_IV",     "EPSG:27564");
        //rgf-93 CC-42 <> CC-50
        HACK.put("RGF_1993_Lambert_Zone_1", "EPSG:3942");
        HACK.put("RGF_1993_Lambert_Zone_2", "EPSG:3943");
        HACK.put("RGF_1993_Lambert_Zone_3", "EPSG:3944");
        HACK.put("RGF_1993_Lambert_Zone_4", "EPSG:3945");
        HACK.put("RGF_1993_Lambert_Zone_5", "EPSG:3946");
        HACK.put("RGF_1993_Lambert_Zone_6", "EPSG:3947");
        HACK.put("RGF_1993_Lambert_Zone_7", "EPSG:3948");
        HACK.put("RGF_1993_Lambert_Zone_8", "EPSG:3949");
        HACK.put("RGF_1993_Lambert_Zone_9", "EPSG:3950");
    }
    @Deprecated
    public static CoordinateReferenceSystem parseWKT(final String wkt) throws FactoryException {
        ensureNonNull("wkt", wkt);
        final CoordinateReferenceSystem crs = getCRSFactory().createFromWKT(wkt);
