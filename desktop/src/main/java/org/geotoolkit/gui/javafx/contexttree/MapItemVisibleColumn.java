...
/**
 *
 * TODO : remove with next geotk version 4.0-MC0069+
 */
public class MapItemVisibleColumn extends TreeTableColumn{
    ...
    public MapItemVisibleColumn() {
        ...
        setCellValueFactory((Object param) -> {
            try {
                return FXUtilities.beanProperty(((TreeTableColumn.CellDataFeatures)param).getValue().getValue(), "visible", Boolean.class);
