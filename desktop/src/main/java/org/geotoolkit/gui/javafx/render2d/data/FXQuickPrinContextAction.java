...
/**
 * TODO: Remove me when switching of Geotk version in which the class "FXQuickPrintContextAction" will exist, with a "t" in print.
 *
...
public class FXQuickPrinContextAction extends FXMapAction {
    ...
    public FXQuickPrinContextAction(FXMap map) {
        // TODO: the bundle waits for a class named FXQuickPrintContextAction, with a "t" in print
        // So hard code the label
        ...
        super(map, "Impression rapide", "Impression rapide", ICON_PRINT);
    }
    ...
    public void accept(ActionEvent event) {
        ...
        try {
            ...
            // TODO: the bundle waits for a class named FXQuickPrintContextAction, with a "t" in print
            // So hard code the label
            fileChooser.setTitle("Impression rapide");
