...
public class MAIN {
    ...
    private static void extractTables(String[] args) {
        try {
            args = new String[]{"-in", "/home/estelle/Projects/SIRS-FranceDigues/tableau_synthese.pdf",
                    "-out", "/home/estelle/Projects/SIRS-FranceDigues/tableau_synthese.html",
            "-el", "0@0,1@0,-1@1"};
            List<Integer> pages = getPages(args);
            List<Integer> exceptPages = getExceptPages(args);
            List<Integer[]> exceptLines = getExceptLines(args);
            String in = "/home/estelle/Projects/SIRS-FranceDigues/tableau_synthese.pdf";
            String out = "/home/estelle/Projects/SIRS-FranceDigues/tableau_synthese.html";

            PDFTableExtractor extractor = (new PDFTableExtractor())
                    .setSource(in);
            //page - if null then all pages other than exceptPage will be converted
