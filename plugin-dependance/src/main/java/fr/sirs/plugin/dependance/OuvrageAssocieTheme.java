...
/**
 * Thème des ouvrages associés d'aménagement hydraulique
 *
 * @author Gavens Maxime (Geomatys)
 */
public class OuvrageAssocieTheme extends AbstractDescriptionTheme {

    public OuvrageAssocieTheme() {
        super("Ouvrages associés", "Ouvrages associés");
    }
