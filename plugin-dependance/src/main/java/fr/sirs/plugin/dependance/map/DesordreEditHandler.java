 ...
 */
public class DesordreEditHandler extends AbstractNavigationHandler {
     ...
     */
    private FeatureMapLayer desordreLayer;

    /**
     * La dépendance en cours.
     */
    private DesordreDependance dependance;
    ...
    public void install(FXMap component) {
        ...
        desordreLayer = PluginDependance.getDesordreLayer();
    }
    ...
    private class MouseListen extends FXPanMouseListen {
        ...
        public MouseListen() {
            super(DesordreEditHandler.this);
        }
        ...
        public void mouseClicked(MouseEvent e) {
            ...
            if (MouseButton.PRIMARY.equals(e.getButton())) {
                if (dependance == null) {
                    ...
                    map.getCanvas().getGraphicsIn(clickArea, new AbstractGraphicVisitor() {
                        ...
                        public void visit(ProjectedFeature graphic, RenderingContext2D context, SearchAreaJ2D area) {
                            ...
                            if(bean instanceof DesordreDependance){
                                helper = new EditionHelper(map, graphic.getLayer());
                                dependance = (DesordreDependance)bean;
                    ...
                    if (newDependance) {
                        ...
                        if (helper == null) {
                            if (DesordreDependance.class.isAssignableFrom(clazz)) {
                                helper = new EditionHelper(map, desordreLayer);
                            }
                        }
                ...
                if (dependance == null) {
                    ...
                    final AbstractSIRSRepository<DesordreDependance> repodep = Injector.getSession().getRepositoryForClass(clazz);
                    ...
                    deleteItem.setOnAction((ActionEvent event) -> {
                        ...
                        if (result.isPresent() && result.get()==YES) {
                            Injector.getBean(DesordreDependanceRepository.class).remove((DesordreDependance)dependance);
                            // On quitte le mode d'édition.
                            reset();
                        }
                    });
