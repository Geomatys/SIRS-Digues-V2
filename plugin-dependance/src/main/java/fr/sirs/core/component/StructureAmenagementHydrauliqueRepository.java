 ...
 */
@View(name=BY_AMENAGEMENT_HYDRAULIQUE_ID, map="function(doc) {if(doc['@class']=='fr.sirs.core.model.StructureAmenagementHydraulique') { if(doc.amenagementHydrauliqueId==null) {emit('-1', doc._id)} else {emit(doc.amenagementHydrauliqueId, doc._id)}}}")
